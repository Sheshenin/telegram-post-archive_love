...
- GitHub-репозиторий для этого клона пока не создавался.
...
- проект пока существует как локальный клон в `/home/deploy/app/telegram-post-archive_love`;
- git-репозиторий для этого клона ещё не инициализирован;
- публикация в GitHub ещё не выполнялась.
